...
<html lang="en">
    ...
    <head>
        ...
        <title>FPT Pizza - Update Account</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form  action="accountupdate" method="POST" enctype="multipart/form-data">
                        <div>
                            <div class="form-group"><h2>Update Account</h2></div>
                            <!--<div class="form-group">-->
                                <!--<label for="userid">User ID:</label>-->
                                <input type="hidden"  class="form-control" name="userid" id="userid" value="<%= account.getUserID()%>">
                                <!--<div id="nameError" class="error"></div>-->
                            <!--</div>-->
                            <div class="form-group">
                                <label for="name">Full Name:</label>
                                <input type="text"  class="form-control" name="name" id="name" value="<%= account.getFullName()%>">
                                <div id="nameError" class="error"></div>
                            </div>
                            <%
                                if (account.getImage().equalsIgnoreCase("")) {
                            %>
                            <div class="form-group">
                                ...
                                <img class="img-responsive" src="" width="300px" height="300px" alt="Preview" style="display: block" id="previewImage"/>
                            </div>
                            <%
                            } else {
                                try {
                                    String imgName = "D:\\PizzaStoreManagement\\PizzaStoreManagement\\images\\" + account.getImage();
                            ...
                            <div class="form-group">
                                ...
                                <img class="img-responsive" src="data:image/jpg;base64, <%=b64%>" width="100px" height="100px" alt="Preview" style="display: block" id="previewImage"/>
                            </div>
                            <%
                                    } catch (IOException e) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="password" id="password" value="<%= account.getPassword()%>">
                                <div id="nameError" class="error"></div>
                            </div>
                            <div class="form-group">
                                <label for="roleID">Role ID:</label>
                                <!--<input type="text"  class="form-control" name="phone" id="phone" value="<%= account.getPhone()%>">-->
                                <!--<div id="nameError" class="error"></div>-->
                                <select name="roleID" class="form-control">
                                    <%
                                        if (account.getRoleID().equalsIgnoreCase("US")) {
                                    %>
                                    <option selected="true" value="US">US</option>
                                    ...
                                    <option selected="true" value="AD">AD</option>
                                    <%                                        }
                                    %>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="address" id="address" value="<%= account.getAddress()%>">
                                <div id="nameError" class="error"></div>
                            </div>
                            <div class="form-group">
                                <button  name="action" value="accountupdate" type="submit" class="btn btn-primary" style="padding: 10px 20px; text-align: center">Update</button>
                            </div>
                            <div>
