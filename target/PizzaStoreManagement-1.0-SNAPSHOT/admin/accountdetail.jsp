...
<html lang="en">
    ...
    <head>
        ...
        <title>FPT Pizza - Detail Account</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="ml-4">
                        ...
                        %>
                        <img src="data:image/jpg;base64, <%=b64%>" width="150px" height="150px" alt="alt" class="" />
                        <%
                            } catch (IOException e) {
                                System.out.println("Error: " + e);
                            }
                        %>
                        <p style="margin-top: 2px">User ID: <%= account.getUserID()%></p>
                        <p>Full Name: <%= account.getFullName()%></p>
                        <p>Password: <%= account.getPassword()%></p>
                        <p>Role ID: <%= account.getRoleID()%></p>
