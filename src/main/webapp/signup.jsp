...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="signup" class="nav-link">Sign Up</a></li>
                            <%
                                }
                            %>
                    </ul>
        ...
        <form style="margin-top: 70px" action="signup" method="POST" >
            <h3>Sign Up Here</h3>
        ...
        <!-- Footer -->
        <footer style="margin-top: 790px" class="ftco-footer ftco-section img">
