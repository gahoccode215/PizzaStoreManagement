...
<html lang="en">
    ...
    <head>
        ...
        <title>FPT Pizza - Add Account</title>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form  action="accountadd" method="POST" enctype="multipart/form-data">
                        <div>
                            <div class="form-group"><h2>Add Account</h2></div>
                            ...
                            <div class="form-group">
                                <button name="action" value="accountadd" type="submit" class="btn btn-primary" style="padding: 10px 20px; text-align: center">Add</button>
                            </div>
                            <div>
